...
if($_POST['Submit'] && $error==0){
	...
	$updatedata="UPDATE te_student_batch set bt_fee_waiver='".$_POST['one']."', bt_approver_comments='".$_POST['approve_comment']."', approve_status='".$_POST['two']."',batch_transfer_fee='".$btfee."' where id='".$res['new_student_batch_id']."'";
	...
	if($_POST['two']=='Approved'){
		...
		$data['crm_student_batch']	= $student_batch;
	    $ch     = curl_init();
