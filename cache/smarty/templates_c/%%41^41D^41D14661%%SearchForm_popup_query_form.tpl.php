<?php /* Smarty version 2.6.29, created on 2017-03-09 23:52:18
         compiled from cache/themes/SuiteR/modules/te_student_batch/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/te_student_batch/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/themes/SuiteR/modules/te_student_batch/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/te_student_batch/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/te_student_batch/SearchForm_popup_query_form.tpl', 45, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/te_student_batch/SearchForm_popup_query_form.tpl', 52, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/te_student_batch/SearchForm_popup_query_form.tpl', 82, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='batch_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BATCH','module' => 'te_student_batch'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['batch_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['batch_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['batch_advanced']['value']; ?>
...
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['batch_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['batch_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"popup_query_form","field_to_name_array":{"id":"te_ba_batch_id_c_advanced","name":"batch_advanced"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['batch_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['batch_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'te_student_batch'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
