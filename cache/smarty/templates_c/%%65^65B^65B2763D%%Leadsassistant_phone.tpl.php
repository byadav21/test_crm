...
<?php if (strlen ( $this->_tpl_vars['fields']['assistant_phone']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['assistant_phone']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['assistant_phone']['value']); ?>
<?php endif; ?>  
