<?php /* Smarty version 2.6.29, created on 2016-12-28 23:24:36
         compiled from cache/themes/SuiteR/modules/te_pr_Programs/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteR/modules/te_pr_Programs/EditView.tpl', 38, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/te_pr_Programs/EditView.tpl', 57, false),array('function', 'sugar_include', 'cache/themes/SuiteR/modules/te_pr_Programs/EditView.tpl', 44, false),array('function', 'counter', 'cache/themes/SuiteR/modules/te_pr_Programs/EditView.tpl', 50, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/te_pr_Programs/EditView.tpl', 56, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/te_pr_Programs/EditView.tpl', 100, false),)), $this); ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=te_pr_Programs'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
' title=''      accesskey='7'  >
<td valign="top" id='te_in_institutes_te_pr_programs_1_name_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TE_IN_INSTITUTES_TE_PR_PROGRAMS_1_FROM_TE_IN_INSTITUTES_TITLE','module' => 'te_pr_Programs'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1te_in_institutes_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"te_in_institutes_te_pr_programs_1te_in_institutes_ida","name":"te_in_institutes_te_pr_programs_1_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['id_name']; ?>
...
_<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_pr_programs_1_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='director_name_c_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DIRECTOR_NAME','module' => 'te_pr_Programs'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['director_name_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['director_name_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['director_name_c']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['director_name_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['director_name_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title='Program Director informa'      >
<td valign="top" id='email_address_c_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_ADDRESS','module' => 'te_pr_Programs'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['email_address_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['email_address_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['email_address_c']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['email_address_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['email_address_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title='Email Address '      >
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='contact_number_c_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_NUMBER','module' => 'te_pr_Programs'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['contact_number_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['contact_number_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['contact_number_c']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['contact_number_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['contact_number_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title='  Contact Number director'      >
<td valign="top" id='mobile_number_c_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_MOBILE_NUMBER','module' => 'te_pr_Programs'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['mobile_number_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['mobile_number_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['mobile_number_c']['value']); ?>
<?php endif; ?>  
...
' title='Mobile Number' tabindex='0'	  class="phone" >
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean(); ?>
<?php if ($this->_tpl_vars['fieldsUsed'] > 0): ?>
<?php echo $this->_tpl_vars['tableRow']; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'te_pr_Programs'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
addToValidateBinaryDependency(\'EditView\', \'te_in_institutes_te_pr_programs_1_name\', \'alpha\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'te_pr_Programs','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TE_IN_INSTITUTES_TE_PR_PROGRAMS_1_FROM_TE_IN_INSTITUTES_TITLE','module' => 'te_pr_Programs','for_js' => true), $this);?>
<?php echo '\', \'te_in_institutes_te_pr_programs_1te_in_institutes_ida\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_te_in_institutes_te_pr_programs_1_name\']={"form":"EditView","method":"query","modules":["te_in_institutes"],"group":"or","field_list":["name","id"],"populate_list":["te_in_institutes_te_pr_programs_1_name","te_in_institutes_te_pr_programs_1te_in_institutes_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>
