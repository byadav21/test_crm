...
'></script>
<script type='text/javascript' src='<?php echo smarty_function_sugar_getjspath(array('file' => 'custom/modules/Users/UserEditView.js'), $this);?>
'></script>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'Email','module' => 'Users'), $this);?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='neox_user_label' width='12.5%' scope="col">
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['neox_user']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['neox_user']['name']; ?>
' size='30' 
maxlength='100' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
<td valign="top" id='neox_password_label' width='12.5%' scope="col">
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['neox_password']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['neox_password']['name']; ?>
' size='30' 
maxlength='100' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='neox_extension_label' width='12.5%' scope="col">
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['neox_extension']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['neox_extension']['name']; ?>
' size='30' 
maxlength='100' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='full_name_label' width='12.5%' scope="col">
...
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
<td valign="top" id='user_access_type_label' width='12.5%' scope="col">
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['user_access_type']['value'] ) && $this->_tpl_vars['fields']['user_access_type']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['user_access_type']['options'],'selected' => $this->_tpl_vars['fields']['user_access_type']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['user_access_type']['options'],'selected' => $this->_tpl_vars['fields']['user_access_type']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['user_access_type']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['user_access_type']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
<?php echo '");
...
<?php echo '.ds = new Y.DataSource.Function({
	...
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['user_access_type']['name']; ?>
');
...
<?php endif; ?>
<td valign="top" id='designation_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESIGNATION','module' => 'Users'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['designation']['value'] ) && $this->_tpl_vars['fields']['designation']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['designation']['options'],'selected' => $this->_tpl_vars['fields']['designation']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['designation']['options'],'selected' => $this->_tpl_vars['fields']['designation']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['designation']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['designation']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
<?php echo '");
...
<?php echo '.ds = new Y.DataSource.Function({
	...
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['designation']['name']; ?>
');
...
<?php echo '\' );
addToValidate(\'EditView\', \'last_name\', \'name\', false,\''; ?>
...
<?php echo '\' );
addToValidate(\'EditView\', \'user_access_type\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_USERTYPE','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'designation\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESIGNATION','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'neox_user\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NEOXUSER','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'neox_password\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NEOXPASS','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'neox_extension\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NEOXEXTENSION','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
