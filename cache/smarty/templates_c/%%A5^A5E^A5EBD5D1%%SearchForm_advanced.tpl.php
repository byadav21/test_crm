<?php /* Smarty version 2.6.29, created on 2016-12-29 01:48:52
         compiled from cache/themes/SuiteR/modules/te_target_campaign/SearchForm_advanced.tpl */ ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.33333333333%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'te_target_campaign'), $this);?>
</label>
		</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.33333333333%' >
		...
		<label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'te_target_campaign'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
