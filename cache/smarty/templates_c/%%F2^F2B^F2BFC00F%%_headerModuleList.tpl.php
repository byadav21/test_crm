<?php /* Smarty version 2.6.29, created on 2017-02-16 03:39:30
         compiled from custom/themes/SuiteR/tpls/_headerModuleList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_link', 'custom/themes/SuiteR/tpls/_headerModuleList.tpl', 53, false),)), $this); ?>
...
?>
                        <?php if ($this->_tpl_vars['name'] == $this->_tpl_vars['MODULE_TAB']): ?>
                            <li class="topnav" style="display:none;">
                                <?php if ($this->_tpl_vars['name'] != 'Home'): ?>
...
?>
            ...
            <div id="globalLinks" class="dropdown nav navbar-nav navbar-right">
                <li id="usermenu" class="dropdown-toggle" aria-expanded="true">
                    <a style="border-bottom:0px;"href='index.php?module=Users&action=EditView&record=<?php echo $this->_tpl_vars['CURRENT_USER_ID']; ?>
...
"><span><?php echo $this->_tpl_vars['item']['LABEL']; ?>
                ...
                <div id="recentlyViewedSidebar" ><span id = "statusCount"><h2 style="display:none;">Status Wise Count</h2><?php echo $this->_tpl_vars['statusWiseCount']; ?>
...
">
                ...
                <div id="favoritesSidebar" style="display:none;">
