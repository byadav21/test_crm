...
<?php if (strlen ( $this->_tpl_vars['fields']['opportunity_id']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['opportunity_id']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['opportunity_id']['value']); ?>
<?php endif; ?>  
