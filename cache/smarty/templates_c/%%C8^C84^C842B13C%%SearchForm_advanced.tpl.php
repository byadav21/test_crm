<?php /* Smarty version 2.6.29, created on 2017-03-07 15:00:02
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='email_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL','module' => 'Leads'), $this);?>
</label>
    	</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='batch_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BATCH','module' => 'Leads'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['batch_c_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['batch_c_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['batch_c_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['te_ba_batch_id_c_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['te_ba_batch_id_c_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['batch_c_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['batch_c_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"te_ba_batch_id_c_advanced","name":"batch_c_advanced"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['batch_c_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['batch_c_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['te_ba_batch_id_c_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='status_description_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS_DESCRIPTION','module' => 'Leads'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'status_description_advanced','name' => 'status_description_advanced[]','options' => $this->_tpl_vars['fields']['status_description_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['status_description_advanced']['value']), $this);?>
