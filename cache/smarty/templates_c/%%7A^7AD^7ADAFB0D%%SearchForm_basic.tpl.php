<?php /* Smarty version 2.6.29, created on 2016-12-29 00:12:58
         compiled from cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_basic.tpl', 44, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_basic.tpl', 53, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_basic.tpl', 127, false),array('modifier', 'count', 'cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_basic.tpl', 114, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='batch_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BATCH','module' => 'te_budgeted_campaign'), $this);?>
</label>
    	</td>
...
"><?php echo smarty_function_sugar_getimage(array('name' => "id-ff-clear",'alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_CLEAR'],'ext' => ".png",'other_attributes' => ''), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='week_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_WEEK','module' => 'te_budgeted_campaign'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['week_basic']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['week_basic']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['week_basic']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['week_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['week_basic']['name']; ?>
' size='30' 
    maxlength='2' 
...
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_USER_FILTER','module' => 'te_budgeted_campaign'), $this);?>
</label>
    	</td>
