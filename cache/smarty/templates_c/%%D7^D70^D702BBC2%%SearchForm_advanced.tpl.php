<?php /* Smarty version 2.6.29, created on 2016-12-29 01:05:48
         compiled from cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_advanced.tpl', 44, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_advanced.tpl', 84, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/te_budgeted_campaign/SearchForm_advanced.tpl', 97, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.33333333333%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'te_budgeted_campaign'), $this);?>
</label>
		</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.33333333333%' >
		...
		<label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'te_budgeted_campaign'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_batch_advanced\']={"form":"search_form","method":"query","modules":["te_ba_Batch"],"group":"or","field_list":["name","id"],"populate_list":["batch_advanced","te_ba_batch_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_te_utm_te_budgeted_campaign_1_name_advanced\']={"form":"search_form","method":"query","modules":["te_utm"],"group":"or","field_list":["name","id"],"populate_list":["te_utm_te_budgeted_campaign_1_name_advanced","te_utm_te_budgeted_campaign_1te_utm_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>