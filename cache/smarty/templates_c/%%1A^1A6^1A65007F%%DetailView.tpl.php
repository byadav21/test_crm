<?php /* Smarty version 2.6.29, created on 2017-02-03 03:58:13
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='te_vendor'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='te_vendor'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='te_vendor'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='te_vendor'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<div id="te_vendor_detailview_tabs"
>
<div >
...
<td class="inlineEdit" type="varchar" field="contact_name" width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['contact_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['contact_name']['name']; ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['phone']['hidden']): ?>
...
<td class="inlineEdit" type="varchar" field="phone" width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['phone']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['vendor_status']['hidden']): ?>
...
<td class="inlineEdit" type="enum" field="vendor_status" width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['vendor_status']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['vendor_status']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['vendor_status']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['vendor_status']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['vendor_status']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['vendor_status']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['vendor_status']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['vendor_status']['options'][$this->_tpl_vars['fields']['vendor_status']['value']]; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'te_vendor'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
...
<?php $this->assign('value', "2016-12-28"); ?>
