<?php /* Smarty version 2.6.29, created on 2016-12-29 00:26:11
         compiled from cache/themes/SuiteR/modules/te_ba_Batch/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/te_ba_Batch/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/themes/SuiteR/modules/te_ba_Batch/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/te_ba_Batch/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/te_ba_Batch/SearchForm_advanced.tpl', 44, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/te_ba_Batch/SearchForm_advanced.tpl', 87, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.33333333333%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'te_ba_Batch'), $this);?>
</label>
		</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.33333333333%' >
		...
		<label for='te_in_institutes_te_ba_batch_1_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TE_IN_INSTITUTES_TE_BA_BATCH_1_FROM_TE_IN_INSTITUTES_TITLE','module' => 'te_ba_Batch'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_ba_batch_1_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_ba_batch_1_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_ba_batch_1_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_ba_batch_1te_in_institutes_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_ba_batch_1te_in_institutes_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_ba_batch_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_ba_batch_1_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"te_in_institutes_te_ba_batch_1te_in_institutes_ida_advanced","name":"te_in_institutes_te_ba_batch_1_name_advanced"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_ba_batch_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_ba_batch_1_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['te_in_institutes_te_ba_batch_1te_in_institutes_ida_advanced']['name']; ?>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_te_in_institutes_te_ba_batch_1_name_advanced\']={"form":"search_form","method":"query","modules":["te_in_institutes"],"group":"or","field_list":["name","id"],"populate_list":["te_in_institutes_te_ba_batch_1_name_advanced","te_in_institutes_te_ba_batch_1te_in_institutes_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_te_pr_programs_te_ba_batch_1_name_advanced\']={"form":"search_form","method":"query","modules":["te_pr_Programs"],"group":"or","field_list":["name","id"],"populate_list":["te_pr_programs_te_ba_batch_1_name_advanced","te_pr_programs_te_ba_batch_1te_pr_programs_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>