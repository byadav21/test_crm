<?php /* Smarty version 2.6.29, created on 2017-02-02 12:14:09
         compiled from cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl', 38, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl', 57, false),array('modifier', 'lookup', 'cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl', 96, false),array('modifier', 'count', 'cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl', 198, false),array('modifier', 'default', 'cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl', 665, false),array('function', 'sugar_include', 'cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl', 44, false),array('function', 'counter', 'cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl', 50, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl', 56, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl', 71, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl', 99, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl', 627, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteR/modules/te_disposition/form_SubpanelQuickCreate_te_disposition.tpl', 635, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('form_SubpanelQuickCreate_te_disposition'); <?php if ($this->_tpl_vars['isDuplicate']): ?>_form.return_id.value=''; <?php endif; ?>_form.action.value='Save'; if(check_form('QuickCreate'))SUGAR.ajaxUI.submitForm(_form);return false;" type="submit" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=te_disposition'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
&module_name=te_disposition", true, false,  { "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] } ); return false;' type="button" value="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
...
<div id="form_SubpanelQuickCreate_te_disposition_tabs"
>
<div >
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'te_disposition'), $this);?>
...
<?php endif; ?>
<td valign="top" id='status_detail_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS_DETAIL','module' => 'te_disposition'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['status_detail']['value'] ) && $this->_tpl_vars['fields']['status_detail']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['status_detail']['options'],'selected' => $this->_tpl_vars['fields']['status_detail']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['status_detail']['options'],'selected' => $this->_tpl_vars['fields']['status_detail']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['status_detail']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['status_detail']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
<?php echo '");
...
<?php echo '.ds = new Y.DataSource.Function({
	...
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['status_detail']['name']; ?>
');
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NOTE','module' => 'te_disposition'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATEOFCALLBACK','module' => 'te_disposition'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
_date",
    form : "form_SubpanelQuickCreate_te_disposition",
...
<td valign="top" id='date_of_followup_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATEOFFOLLOWUP','module' => 'te_disposition'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='date_of_prospect_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATEOFPROSPECT','module' => 'te_disposition'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
YAHOO.util.Event.onContentReady("form_SubpanelQuickCreate_te_disposition",
    function () { initEditView(document.forms.form_SubpanelQuickCreate_te_disposition) });
...
<script type="text/javascript">
addForm(\'form_SubpanelQuickCreate_te_disposition\');addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'name\', \'name\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'modified_user_id\', \'assigned_user_name\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'modified_by_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'created_by\', \'assigned_user_name\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'created_by_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'description\', \'text\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'deleted\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'assigned_user_id\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'assigned_user_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'status\', \'enum\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'status_detail\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS_DETAIL','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'lead_mobile\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_LEAD_MOBILE','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'lead_email\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_LEAD_EMAIL','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'show_button\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_UPDATE_DISPOSITION','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'batch_name\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_BATCH','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'program_name\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROGRAM','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'te_disposition_leads_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TE_DISPOSITION_LEADS_FROM_LEADS_TITLE','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'date_of_callback_date\', \'date\', false,\'Call back Date\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'date_of_followup_date\', \'date\', false,\'Followup Date\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'date_of_prospect_date\', \'date\', false,\'Prospect Date\' );
addToValidate(\'form_SubpanelQuickCreate_te_disposition\', \'unique_call_id\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_UNIQUECALLID','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo '\' );
addToValidateBinaryDependency(\'form_SubpanelQuickCreate_te_disposition\', \'assigned_user_name\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'te_disposition','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'te_disposition','for_js' => true), $this);?>
