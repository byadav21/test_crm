...
<input type="text" name="{$fields.te_vendor_aos_contracts_1_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.te_vendor_aos_contracts_1_name.name}" size="" value="{$fields.te_vendor_aos_contracts_1_name.value}" title='' autocomplete="off"  	 accesskey='7'  >
<input type="hidden" name="{$fields.te_vendor_aos_contracts_1_name.id_name}" 
id="{$fields.te_vendor_aos_contracts_1_name.id_name}" 
value="{$fields.te_vendor_aos_contracts_1te_vendor_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.te_vendor_aos_contracts_1_name.name}" id="btn_{$fields.te_vendor_aos_contracts_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.te_vendor_aos_contracts_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"te_vendor_aos_contracts_1te_vendor_ida","name":"te_vendor_aos_contracts_1_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.te_vendor_aos_contracts_1_name.name}" id="btn_clr_{$fields.te_vendor_aos_contracts_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.te_vendor_aos_contracts_1_name.name}', '{$fields.te_vendor_aos_contracts_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.te_vendor_aos_contracts_1_name.name}']) != 'undefined'",
		enableQS
);
</script>
...
<select name="{$fields.performance_metrics.name}" 
id="{$fields.performance_metrics.name}" 
title=''       
>
{if isset($fields.performance_metrics.value) && $fields.performance_metrics.value != ''}
{html_options options=$fields.performance_metrics.options selected=$fields.performance_metrics.value}
{else}
{html_options options=$fields.performance_metrics.options selected=$fields.performance_metrics.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.performance_metrics.options }
{capture name="field_val"}{$fields.performance_metrics.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.performance_metrics.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.performance_metrics.name}" 
id="{$fields.performance_metrics.name}" 
title=''          
>
{if isset($fields.performance_metrics.value) && $fields.performance_metrics.value != ''}
...
<input
id="{$fields.performance_metrics.name}-input"
name="{$fields.performance_metrics.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.performance_metrics.name}-image"></button><button type="button"
id="btn-clear-{$fields.performance_metrics.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.performance_metrics.name}-input', '{$fields.performance_metrics.name}');sync_{$fields.performance_metrics.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
	...
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.performance_metrics.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.performance_metrics.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.performance_metrics.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.performance_metrics.name}');
			...
			//global variable 
			sync_{/literal}{$fields.performance_metrics.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.performance_metrics.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.performance_metrics.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_VOLUME' module='AOS_Contracts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.volume_c.value) <= 0}
{assign var="value" value=$fields.volume_c.default_value }
{else}
{assign var="value" value=$fields.volume_c.value }
{/if}  
<input type='text' name='{$fields.volume_c.name}' 
id='{$fields.volume_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PO_NUMBER' module='AOS_Contracts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.po_number.value) <= 0}
{assign var="value" value=$fields.po_number.default_value }
{else}
{assign var="value" value=$fields.po_number.value }
{/if}  
<input type='text' name='{$fields.po_number.name}' 
id='{$fields.po_number.name}' size='30' 
maxlength='40' 
value='{$value}' title=''      >
</tr>
{/capture}
...
addToValidate('EditView', 'renewal_reminder_date', 'date', false,'{/literal}{sugar_translate label='LBL_RENEWAL_REMINDER_DATE' module='AOS_Contracts' for_js=true}{literal}' );
...
addToValidate('EditView', 'te_vendor_aos_contracts_1_name', 'relate', true,'{/literal}{sugar_translate label='LBL_TE_VENDOR_AOS_CONTRACTS_1_FROM_TE_VENDOR_TITLE' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'te_vendor_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_VENDOR_TE_VENDOR_ID' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'vendor', 'relate', false,'{/literal}{sugar_translate label='LBL_VENDOR' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'expiry_valume_c', 'int', false,'{/literal}{sugar_translate label='LBL_EXPIRY_VALUME' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'performance_metrics', 'enum', false,'{/literal}{sugar_translate label='Performance Metrics' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'volume_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_VOLUME' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'target_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TARGET' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'rate_c', 'currency', true,'{/literal}{sugar_translate label='LBL_RATE' module='AOS_Contracts' for_js=true}{literal}' );
addToValidate('EditView', 'po_number', 'varchar', false,'{/literal}{sugar_translate label='LBL_PO_NUMBER' module='AOS_Contracts' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'te_vendor_aos_contracts_1_name', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='AOS_Contracts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_TE_VENDOR_AOS_CONTRACTS_1_FROM_TE_VENDOR_TITLE' module='AOS_Contracts' for_js=true}{literal}', 'te_vendor_aos_contracts_1te_vendor_ida' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_te_vendor_aos_contracts_1_name']={"form":"EditView","method":"query","modules":["te_vendor"],"group":"or","field_list":["name","id"],"populate_list":["te_vendor_aos_contracts_1_name","te_vendor_aos_contracts_1te_vendor_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>{/literal}
