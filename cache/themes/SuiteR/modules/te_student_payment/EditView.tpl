...
{capture name="label" assign="label"}{sugar_translate label='LBL_TE_STUDENT_TE_STUDENT_PAYMENT_1_FROM_TE_STUDENT_TITLE' module='te_student_payment'}{/capture}
...
<input type="text" name="{$fields.te_student_te_student_payment_1_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.te_student_te_student_payment_1_name.name}" size="" value="{$fields.te_student_te_student_payment_1_name.value}" title='' autocomplete="off"  	 accesskey='7'  >
<input type="hidden" name="{$fields.te_student_te_student_payment_1_name.id_name}" 
id="{$fields.te_student_te_student_payment_1_name.id_name}" 
value="{$fields.te_student_te_student_payment_1te_student_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.te_student_te_student_payment_1_name.name}" id="btn_{$fields.te_student_te_student_payment_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.te_student_te_student_payment_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"te_student_te_student_payment_1te_student_ida","name":"te_student_te_student_payment_1_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.te_student_te_student_payment_1_name.name}" id="btn_clr_{$fields.te_student_te_student_payment_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.te_student_te_student_payment_1_name.name}', '{$fields.te_student_te_student_payment_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.te_student_te_student_payment_1_name.name}']) != 'undefined'",
		enableQS
);
</script>
<td valign="top" id='batch_id_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_BATCH_ID' module='te_student_payment'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.batch_id.name}" class="sqsEnabled" tabindex="0" id="{$fields.batch_id.name}" size="" value="{$fields.batch_id.value}" title='' autocomplete="off"  	 >
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"te_student_batch_id_c","name":"batch_id"}}{/literal}, 
"single", 
true
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PAYMENT_TYPE' module='te_student_payment'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PAYMENT_SOURCE' module='te_student_payment'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_AMOUNT' module='te_student_payment'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_OF_PAYMENT' module='te_student_payment'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PAYMENT_REALIZED' module='te_student_payment'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TRANSACTION_ID' module='te_student_payment'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='te_student_payment'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='te_student_payment' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='te_student_payment' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='te_student_payment' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='te_student_payment' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='te_student_payment' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='te_student_payment' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='te_student_payment' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='te_student_payment' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='te_student_payment' for_js=true}{literal}' );
addToValidate('EditView', 'te_student_batch_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_BATCH_ID_TE_STUDENT_BATCH_ID' module='te_student_payment' for_js=true}{literal}' );
...
addToValidate('EditView', 'payment_source', 'enum', false,'{/literal}{sugar_translate label='LBL_PAYMENT_SOURCE' module='te_student_payment' for_js=true}{literal}' );
addToValidate('EditView', 'te_student_te_student_payment_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_TE_STUDENT_TE_STUDENT_PAYMENT_1_FROM_TE_STUDENT_TITLE' module='te_student_payment' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='te_student_payment' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='te_student_payment' for_js=true}{literal}', 'assigned_user_id' );
addToValidateBinaryDependency('EditView', 'batch_id', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='te_student_payment' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_BATCH_ID' module='te_student_payment' for_js=true}{literal}', 'te_student_batch_id_c' );
addToValidateBinaryDependency('EditView', 'te_student_te_student_payment_1_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='te_student_payment' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_TE_STUDENT_TE_STUDENT_PAYMENT_1_FROM_TE_STUDENT_TITLE' module='te_student_payment' for_js=true}{literal}', 'te_student_te_student_payment_1te_student_ida' );
