...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='8.33333333333%' >
			<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='te_utm'}</label>
		</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.33333333333%' >
		...
		<label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='te_utm'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
