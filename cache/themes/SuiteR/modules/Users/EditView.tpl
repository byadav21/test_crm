...
{capture name="label" assign="label"}{sugar_translate label='Email' module='Users'}{/capture}
...
{/if}  
<input type='text' name='{$fields.neox_user.name}' 
id='{$fields.neox_user.name}' size='30' 
maxlength='100' 
value='{$value}' title=''      >
...
{/if}  
<input type='text' name='{$fields.neox_password.name}' 
id='{$fields.neox_password.name}' size='30' 
maxlength='100' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{/if}  
<input type='text' name='{$fields.neox_extension.name}' 
id='{$fields.neox_extension.name}' size='30' 
maxlength='100' 
value='{$value}' title=''      >
<td valign="top" id='_label' width='12.5%' scope="col">
&nbsp;
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.user_access_type.name}" 
id="{$fields.user_access_type.name}" 
title=''       
>
{if isset($fields.user_access_type.value) && $fields.user_access_type.value != ''}
{html_options options=$fields.user_access_type.options selected=$fields.user_access_type.value}
{else}
{html_options options=$fields.user_access_type.options selected=$fields.user_access_type.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.user_access_type.options }
{capture name="field_val"}{$fields.user_access_type.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.user_access_type.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.user_access_type.name}" 
id="{$fields.user_access_type.name}" 
title=''          
>
{if isset($fields.user_access_type.value) && $fields.user_access_type.value != ''}
...
<input
id="{$fields.user_access_type.name}-input"
name="{$fields.user_access_type.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.user_access_type.name}-image"></button><button type="button"
id="btn-clear-{$fields.user_access_type.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.user_access_type.name}-input', '{$fields.user_access_type.name}');sync_{$fields.user_access_type.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.user_access_type.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.user_access_type.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.user_access_type.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.user_access_type.name}');
			...
			//global variable 
			sync_{/literal}{$fields.user_access_type.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.user_access_type.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.user_access_type.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DESIGNATION' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.designation.name}" 
id="{$fields.designation.name}" 
title=''       
>
{if isset($fields.designation.value) && $fields.designation.value != ''}
{html_options options=$fields.designation.options selected=$fields.designation.value}
{else}
{html_options options=$fields.designation.options selected=$fields.designation.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.designation.options }
{capture name="field_val"}{$fields.designation.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.designation.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.designation.name}" 
id="{$fields.designation.name}" 
title=''          
>
{if isset($fields.designation.value) && $fields.designation.value != ''}
...
<input
id="{$fields.designation.name}-input"
name="{$fields.designation.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.designation.name}-image"></button><button type="button"
id="btn-clear-{$fields.designation.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.designation.name}-input', '{$fields.designation.name}');sync_{$fields.designation.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.designation.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.designation.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.designation.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.designation.name}');
			...
			//global variable 
			sync_{/literal}{$fields.designation.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.designation.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.designation.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
addToValidate('EditView', 'last_name', 'name', false,'{/literal}{sugar_translate label='LBL_LAST_NAME' module='Users' for_js=true}{literal}' );
...
addToValidate('EditView', 'user_access_type', 'enum', false,'{/literal}{sugar_translate label='LBL_USERTYPE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'designation', 'enum', false,'{/literal}{sugar_translate label='LBL_DESIGNATION' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'neox_user', 'varchar', false,'{/literal}{sugar_translate label='LBL_NEOXUSER' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'neox_password', 'varchar', false,'{/literal}{sugar_translate label='LBL_NEOXPASS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'neox_extension', 'varchar', false,'{/literal}{sugar_translate label='LBL_NEOXEXTENSION' module='Users' for_js=true}{literal}' );
