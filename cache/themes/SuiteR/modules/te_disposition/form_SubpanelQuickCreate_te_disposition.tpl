...
addToValidate('form_SubpanelQuickCreate_te_disposition', 'lead_mobile', 'varchar', false,'{/literal}{sugar_translate label='LBL_LEAD_MOBILE' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'lead_email', 'varchar', false,'{/literal}{sugar_translate label='LBL_LEAD_EMAIL' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'show_button', 'varchar', false,'{/literal}{sugar_translate label='LBL_UPDATE_DISPOSITION' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'batch_name', 'varchar', false,'{/literal}{sugar_translate label='LBL_BATCH' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'program_name', 'varchar', false,'{/literal}{sugar_translate label='LBL_PROGRAM' module='te_disposition' for_js=true}{literal}' );
