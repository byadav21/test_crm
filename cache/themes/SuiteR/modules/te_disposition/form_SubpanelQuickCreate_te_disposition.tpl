...
{capture name="label" assign="label"}{sugar_translate label='LBL_NOTE' module='te_disposition'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
YAHOO.util.Event.onContentReady("form_SubpanelQuickCreate_te_disposition",
    function () {ldelim} initEditView(document.forms.form_SubpanelQuickCreate_te_disposition) {rdelim});
...
<script type="text/javascript">
addForm('form_SubpanelQuickCreate_te_disposition');addToValidate('form_SubpanelQuickCreate_te_disposition', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='te_disposition' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_te_disposition', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'status', 'enum', true,'{/literal}{sugar_translate label='LBL_STATUS' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'status_detail', 'enum', false,'{/literal}{sugar_translate label='LBL_STATUS_DETAIL' module='te_disposition' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_te_disposition', 'te_disposition_leads_name', 'relate', false,'{/literal}{sugar_translate label='LBL_TE_DISPOSITION_LEADS_FROM_LEADS_TITLE' module='te_disposition' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_te_disposition', 'unique_call_id', 'varchar', false,'{/literal}{sugar_translate label='LBL_UNIQUECALLID' module='te_disposition' for_js=true}{literal}' );
addToValidateBinaryDependency('form_SubpanelQuickCreate_te_disposition', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='te_disposition' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='te_disposition' for_js=true}{literal}', 'assigned_user_id' );
</script>{/literal}
