...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='8.33333333333%' >
			<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='te_ba_Batch'}</label>
		</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.33333333333%' >
		...
		<label for='te_in_institutes_te_ba_batch_1_name_advanced'>{sugar_translate label='LBL_TE_IN_INSTITUTES_TE_BA_BATCH_1_FROM_TE_IN_INSTITUTES_TITLE' module='te_ba_Batch'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="{$fields.te_in_institutes_te_ba_batch_1_name_advanced.name}"  class="sqsEnabled"   id="{$fields.te_in_institutes_te_ba_batch_1_name_advanced.name}" size="" value="{$fields.te_in_institutes_te_ba_batch_1_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.te_in_institutes_te_ba_batch_1te_in_institutes_ida_advanced.name}" value="{$fields.te_in_institutes_te_ba_batch_1te_in_institutes_ida_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.te_in_institutes_te_ba_batch_1_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.te_in_institutes_te_ba_batch_1_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"te_in_institutes_te_ba_batch_1te_in_institutes_ida_advanced","name":"te_in_institutes_te_ba_batch_1_name_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.te_in_institutes_te_ba_batch_1_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.te_in_institutes_te_ba_batch_1_name_advanced.name}.value = ''; this.form.{$fields.te_in_institutes_te_ba_batch_1te_in_institutes_ida_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
