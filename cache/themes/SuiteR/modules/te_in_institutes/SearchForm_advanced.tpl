...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='8.33333333333%' >
			<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='te_in_institutes'}</label>
		</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.33333333333%' >
		...
		<label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='te_in_institutes'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
