...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"leads_leads_1leads_ida","name":"leads_leads_1_name"}}{/literal}, 
"single", 
true
...
addToValidate('EditView', 'channel', 'varchar', false,'{/literal}{sugar_translate label='Channel' module='Leads' for_js=true}{literal}' );
...
addToValidate('EditView', 'status_d', 'varchar', false,'{/literal}{sugar_translate label='LBL_STATUS_D' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'status_detail_d', 'varchar', false,'{/literal}{sugar_translate label='LBL_STATUS_DETAIL_D' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'description_d', 'varchar', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION_D' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'date_of_callback_date_d', 'varchar', false,'{/literal}{sugar_translate label='LBL_DATE_OF_CALL_BACK_DATE_D' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'date_of_callback_hours_d', 'varchar', false,'{/literal}{sugar_translate label='LBL_DATE_OF_CALL_BACK_HOURS_D' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'date_of_callback_minutes_d', 'varchar', false,'{/literal}{sugar_translate label='LBL_DATE_OF_CALL_BACK_MINUTES_D' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'disposition_id', 'varchar', false,'{/literal}{sugar_translate label='LBL_DISPOSITION_ID' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'date_of_followup_date_d', 'varchar', false,'{/literal}{sugar_translate label='LBL_DATE_OF_FOLLOWUP_DATE_D' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'date_of_followup_hours_d', 'varchar', false,'{/literal}{sugar_translate label='LBL_DATE_OF_FOLLOWUP_HOURS_D' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'date_of_followup_minutes_d', 'varchar', false,'{/literal}{sugar_translate label='LBL_DATE_OF_FOLLOWUP_MINUTES_D' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'date_of_prospect_date_d', 'varchar', false,'{/literal}{sugar_translate label='LBL_DATE_OF_PROSPECT_DATE_D' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'date_of_prospect_hours_d', 'varchar', false,'{/literal}{sugar_translate label='LBL_DATE_OF_PROSPECT_HOURS_D' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'date_of_prospect_minutes_d', 'varchar', false,'{/literal}{sugar_translate label='LBL_DATE_OF_PROSPECT_MINUTES_D' module='Leads' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'leads_leads_1_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Leads' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_LEADS_LEADS_1_FROM_LEADS_L_TITLE' module='Leads' for_js=true}{literal}', 'leads_leads_1leads_ida' );
