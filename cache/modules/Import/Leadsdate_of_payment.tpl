...
<input class="date_input" autocomplete="off" type="text" name="{$fields.date_of_payment.name}" id="{$fields.date_of_payment.name}" value="{$date_value}" title=''  tabindex='1'    size="11" maxlength="10" >
