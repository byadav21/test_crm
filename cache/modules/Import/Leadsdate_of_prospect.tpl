...
<tr valign="middle">
<td nowrap>
<input autocomplete="off" type="text" id="{$fields.date_of_prospect.name}_date" value="{$fields[$fields.date_of_prospect.name].value}" size="11" maxlength="10" title='' tabindex="1" onblur="combo_{$fields.date_of_prospect.name}.update();" onchange="combo_{$fields.date_of_prospect.name}.update(); "    >
...
var combo_{$fields.date_of_prospect.name} = new Datetimecombo("{$fields[$fields.date_of_prospect.name].value}", "{$fields.date_of_prospect.name}", "{$TIME_FORMAT}", "1", '', false, true);
