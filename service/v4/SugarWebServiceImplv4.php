...
class SugarWebServiceImplv4 extends SugarWebServiceImplv3_1 {
    ...
    public function login($user_auth, $application, $name_value_list = array()){
        ...
        if($success)
        {
            ...
            $nameValueArray['user_default_team_id'] = self::$helperObject->get_name_value('user_default_team_id', isset($current_user->default_team)? $current_user->default_team : '');
            ...
            $nameValueArray['mobile_max_list_entries'] = self::$helperObject->get_name_value('mobile_max_list_entries',  isset($sugar_config['wl_list_max_entries_per_page'])? $sugar_config['wl_list_max_entries_per_page'] : '' );
            $nameValueArray['mobile_max_subpanel_entries'] = self::$helperObject->get_name_value('mobile_max_subpanel_entries', isset($sugar_config['wl_list_max_entries_per_subpanel'])? $sugar_config['wl_list_max_entries_per_subpanel'] : '' );
