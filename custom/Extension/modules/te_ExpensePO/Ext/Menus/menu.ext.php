...
//$module_menu[] = array ('index.php?module=te_ExpensePO&action=index', "Report Recipients", 'te_ExpensePO');  
//}


if(in_array($current_user->id,$crrArr) || $current_user->is_admin==1){
  $module_menu[] = array ('index.php?module=te_ExpensePO&action=EditView&return_module=te_ExpensePO&return_action=DetailView',"Create Expense PO", 'te_ExpensePO');
  $module_menu[] = array ('index.php?module=te_ExpensePO&action=index',"View Expense PO", 'te_ExpensePO');
  $module_menu[] = array ('index.php?module=te_Expensepo_Vendor&action=index&parentTab=Global+Settings', "View Vendors", 'te_Expensepo_Vendor');
  $module_menu[] = array ('index.php?action=ajaxui#ajaxUILoc=index.php%3Fmodule%3Dte_Expensepo_Vendor%26action%3DEditView%26return_module%3Dte_Expensepo_Vendor%26return_action%3DDetailView', "Create Vendors", 'te_Expensepo_Vendor');
}
