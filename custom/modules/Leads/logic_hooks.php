...
$hook_array['after_save'][] = Array(24, 'add leads details', 'custom/modules/Leads/eloqua/eloqua_hook.php','eloqua_contact','add_leads_eloqua');
$hook_array['after_save'][] = Array(24, 'add leads indivialids', 'custom/modules/Leads/individual_id_hook.php','individualIdClass','add_individual_id');
