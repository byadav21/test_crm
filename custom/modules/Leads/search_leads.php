...
//      name and email and mobile koi
        ...
        $where.="  tbl1.phone_mobile like '".$mobile_number."'";
		    ...
		    $where.=" AND tbl1.deleted=0 limit 0,100";
                 ...
                 echo  $fetch="SELECT tbl1.id,tbl1.salutation,tbl1.phone_mobile,tbl4.email_address,tbl1.assigned_user_id,tbl1.first_name,tbl1.last_name, tbl1.status,tbl1.date_entered,tbl1.lead_source,tbl2.user_name,tbl2.phone_mobile FROM leads AS tbl1
