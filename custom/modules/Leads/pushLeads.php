...
WHERE l.deleted =0   AND l.status_description= 'New Lead' AND l.neoxstatus='0' and dristi_campagain_id !='' and dristi_api_id !='' AND (l.assigned_user_id= 'NULL' OR l.assigned_user_id ='' OR l.assigned_user_id IS NULL)  order by concat (dristi_campagain_id ,dristi_api_id) limit 500";
