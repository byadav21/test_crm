<section class="moduleTitle"> <h2>Payment Received Report</h2><br/><br/>
    ...
    <div style="width:99%;overflow:hidden;"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="paginationTable">
            <thead>
                {*Start Pagination*}
    ...
    <div style="width:99%;overflow:auto;border:2px dashed #d0d0d0;" class="div-leads-list">                          
        <table cellpadding="0" cellspacing="0" width="{$tablewidth}" border="0" class="list view table footable-loaded footable default">
            ...
            {if empty($paymentList)}<tr class="oddListRowS1"><td align="left"  colspan="30">No Data Found between require filters.</td></tr>{/if}
