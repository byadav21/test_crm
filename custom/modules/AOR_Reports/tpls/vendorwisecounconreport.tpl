<section class="moduleTitle"> <h2>Vendor wise agent conversion summary Report</h2><br/><br/>
    <form name="search_form" id="search_form" class="search_form" method="post" action="index.php?module=AOR_Reports&action=vendorwisecounconreport">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td nowrap="nowrap" >
                            <select name="counselor[]" id="vendor"  class="multiselbox_batch" multiple style="width:300px !important; height: 70px !important;">
                        ...
                        <td scope="row" nowrap="nowrap" width="1%">
                            <label for="vendor_basic">Vendor</label>
                        </td>
                        <td nowrap="nowrap" >
                            <select name="vendor[]" id="vendor"  class="multiselbox_batch" multiple style="width:300px !important; height: 70px !important;">
                                {foreach from =$VendorListData key=key item=vendor}
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="paginationTable">
                        <tbody><tr>
                                ...
                                <td nowrap="nowrap" align="right" class="paginationChangeButtons" width="1%">
                                    ...
                                    {if $left eq 1}
                                        <a href="index.php?module=AOR_Reports&action=vendorwisecounconreport"  name="listViewStartButton" title="Start" class="button" >
                                            <img src="themes/SuiteR/images/start_off.gif?v=S2eFayn4JyvAICLoJ82pZw" align="absmiddle" border="0" alt="Start">
                                        </a>

                                        <a href="index.php?module=AOR_Reports&action=vendorwisecounconreport&page={$page}"  class="button" title="Previous">
                                ...
                                <td nowrap="nowrap" align="right" class="paginationActionButtons" width="1%">
                                    {if $right eq 1}
                                        <a href="index.php?module=AOR_Reports&action=vendorwisecounconreport&page={$pagenext}"  class="button" title="Next" disabled="disabled">
                                            <img src="themes/SuiteR/images/next_off.gif?v=S2eFayn4JyvAICLoJ82pZw" align="absmiddle" border="0" alt="Next">
                                        </a>
                                        <a href="index.php?module=AOR_Reports&action=vendorwisecounconreport&page={$last_page}"  class="button" title="End" disabled="disabled">
