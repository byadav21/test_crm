<section class="moduleTitle"> <h2>Leads Performance Report
</h2><br/><br/>
    <form name="search_form" id="search_form" class="search_form" method="post" action="index.php?module=AOR_Reports&action=viewleadsperformance">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="paginationTable">
                        <tbody><tr>
                                ...
                                <td nowrap="nowrap" align="right" class="paginationChangeButtons" width="1%">
                                    ...
                                    {if $left eq 1}
                                        <a href="index.php?module=AOR_Reports&action=viewleadsperformance"  name="listViewStartButton" title="Start" class="button" >
                                            <img src="themes/SuiteR/images/start_off.gif?v=S2eFayn4JyvAICLoJ82pZw" align="absmiddle" border="0" alt="Start">
                                        </a>

                                        <a href="index.php?module=AOR_Reports&action=viewleadsperformance&page={$page}"  class="button" title="Previous">
                                ...
                                <td nowrap="nowrap" align="right" class="paginationActionButtons" width="1%">
                                    {if $right eq 1}
                                        <a href="index.php?module=AOR_Reports&action=viewleadsperformance&page={$pagenext}"  class="button" title="Next" disabled="disabled">
                                            <img src="themes/SuiteR/images/next_off.gif?v=S2eFayn4JyvAICLoJ82pZw" align="absmiddle" border="0" alt="Next">
                                        </a>
                                        <a href="index.php?module=AOR_Reports&action=viewleadsperformance&page={$last_page}"  class="button" title="End" disabled="disabled">
