...
class AOR_ReportsViewviewleadsperformance extends SugarView
{
    ...
    public function display()
    {
        ...
        {
            $_SESSION['cccon_desc'] = $_GET['desc'];
            $_SESSION['cccon_dispositionName']='';
        }
        ...
        if (isset($_GET['dispositionName']) && $_GET['dispositionName'] != '')
        {
            $_SESSION['cccon_dispositionName'] = $_GET['dispositionName'];
            $_SESSION['cccon_desc']='';
        }
        ...
        if ($_SESSION['cccon_dispositionName'] != '')
        {
            $dispositionName = $_SESSION['cccon_dispositionName'];
            $wherecl   .= " AND  leads.dispositionName='" . $dispositionName . "'";
        }
        

        $showByClick = '';
        if ($_SESSION['cccon_desc'] != '')
        {

            $showByClick = $_SESSION['cccon_desc'];
            $wherecl .= " AND  leads.status_description='". str_replace("_", " ", $showByClick)."'";
        }
        ...
        $sugarSmarty->display('custom/modules/AOR_Reports/tpls/viewleadsperformance.tpl');
    }
