...
class AOR_ReportsViewVendorwiseconversionreport extends SugarView
{
    ...
    public function display()
    {
         ...
         if (isset($_POST['export']) && $_POST['export'] == "Export")
        {
            ...
            $file     = "VendorWiseConversion_report";
            $where    = '';
        ...
        $sugarSmarty->display('custom/modules/AOR_Reports/tpls/vendorwiseconversionreport.tpl');
    }
