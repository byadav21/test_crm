...
class AOR_ReportsViewnewleadutilization extends SugarView
{
    ...
    public function display()
    {
        ...
        $sugarSmarty->display('custom/modules/AOR_Reports/tpls/newleadutilization.tpl');
    }
