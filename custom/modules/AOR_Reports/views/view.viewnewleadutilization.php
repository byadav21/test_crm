...
class AOR_ReportsViewviewnewleadutilization extends SugarView
{
    ...
    function getAttempts($showByClick, $batch_code,$selected_councellors)
    {
        ...
        $leadSql    = "SELECT 
			    ...
			    attempt_log.reg_date as dispo_date,
                            attempt_log.`dispositionCode` as status_detail
                     FROM leads
                     ...
                     LEFT JOIN attempt_log on leads.id=attempt_log.lead_id
...
//        }
        ...
        $sugarSmarty->display('custom/modules/AOR_Reports/tpls/viewnewleadutilization.tpl');
    }
