    ...
    public function display()
    {
       ...
       if(in_array($currentRoleName, $channelHeadArray)){
        ...
        if (isset($_POST['button']) || isset($_POST['export']))
        {
            ...
            $_SESSION['cccon_managers']    = $_REQUEST['managers'];// Not use this code
        ...
        $agentRoleName = array("CHAGENT","SCHAGENT","DMHAGENT","SRMHAGENT","QAAGENT","TRAGENT","VRAGENT");
        // if(in_array($currentRoleName, $agentRoleName)){
        //     $selected_councellors = $current_user->id;
        // } else {
        //     $selected_councellors = $selected_councellors;
        // }
        ...
        $getDayTotalProspect   = $this->getTotalProspect('', '', '', $selected_date, '', $current_userAccess, $CouncellorsList);
        ...
        $getDayWiseConverts   = $this->getActualConverts('', '', '', $selected_date, '', $current_userAccess, $CouncellorsList);
	    ...
	    //$daywise_actual_conversion   = round($daywise_actual_conversion);
            ...
            elseif (($daywise_actual_conversion >= $daywise_targeted_conversion) && ($daywise_actual_conversion != 0 || $daywise_targeted_conversion != 0))
            {
