...
class AOR_ReportsViewBatchwisestatusreport extends SugarView
{
    ...
    public function display()
    {
            ...
            $leadSql = "SELECT COUNT(l.id) AS lead_count,
                ...
                LEFT JOIN te_ba_batch ON lc.te_ba_batch_id_c = te_ba_batch.id
                 WHERE l.deleted=0
                   ...
                   $wherecl
              GROUP BY l.status,lc.te_ba_batch_id_c";
            //echo $leadSql;exit();
        ...
        $sugarSmarty->display('custom/modules/AOR_Reports/tpls/batchwisestatusreport.tpl');
    }
