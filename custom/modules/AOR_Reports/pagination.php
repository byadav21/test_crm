...
class pagination{
  ...
  /**
   * total no. of records found on current page
   * @var int
   */
  ...
  public function set_found_rows($_foundRows){
    $this->_foundRows = $_foundRows;
  }
  ...
  public function get_last_page(){
    ...
    return $this->_totalRows == 0? 0:ceil($this->_totalRows / $this->_perPage);
  }
  /**
   * page_links
   *
