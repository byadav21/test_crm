        ...
        <td style="padding:0px;  border:0px;"  ><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><?php if($reco9['leads']==''){
				echo 0;} else { echo $reco9['leads']; } ?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php if($reco9['conversion']==''){echo 0;}else {echo $reco9['conversion'];}?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php if($reco9['conversion_rate']==''){echo 0;}else {echo $reco9['conversion_rate'];}?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php if($reco9['cpl']==''){echo 0;}else {echo $reco9['cpl'];}?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php if($reco9['cpa']==''){echo 0;}else { echo $reco9['cpa'];}?>&nbsp;</td>
          </tr>
          <tr>
