...
<a id="create_link" href="index.php?module=te_budgeted_campaign&action=EditView&return_module=te_budgeted_campaign&return_action=DetailView" class="utilsLink">
Create
</a>
</span>
 </div>
<div class="row">
   ...
   <div class="maincont">
      ...
      <div class="col-xs-7 " ng-if="results.length > 0" ng-repeat="(key,obj) in results">
          <div class="col-xs-7 text-left div"><a ng-href='index.php?searchFormTab=basic_search&module=te_budgeted_campaign&action=index&query=true&batch_basic=<% obj.name %>'  ><% obj.name %></a></div>
