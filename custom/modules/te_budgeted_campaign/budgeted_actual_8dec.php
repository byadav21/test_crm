    ...
    <td style="border:0px; padding:0px;" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td style="padding:0px;  border:0px;"  ><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><?php echo $reco9['leads']?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php echo $reco9['conversion']?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php echo $reco9['conversion_rate']?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php echo $reco9['cpl']?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php echo $reco9['cpa']?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php echo $reco9['cost']?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php echo $reco9['volume']?>&nbsp;</td>
          </tr>
    ...
    <td valign="top" style="padding:0px; border:0px;" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td  valign="top" style="padding:0px; border:0px;" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
           <td><?php echo $reco3['total_leads'];?>&nbsp;</td>
          </tr>
          <tr>
           <td><?php echo $reco3['converted'];?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php echo round($cpl,3);?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php echo $cpa;?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php echo round($cr,3);?>&nbsp;</td>
          </tr>
          <tr>
            <td><?php echo $reco4['total_cost'];?>&nbsp;</td>
          </tr>
            <tr>
            <td><?php echo $reco4['volume']?>&nbsp;</td>
          </tr>
