...
if(isset($_REQUEST['programId']) && $_REQUEST['programId']!=""){
  $batchSql="SELECT  distinct(b.id),
                    b.name
             FROM te_ba_batch b
             INNER JOIN te_pr_programs_te_ba_batch_1_c r ON b.id=r.te_pr_programs_te_ba_batch_1te_ba_batch_idb
             AND r.te_pr_programs_te_ba_batch_1te_pr_programs_ida='".$_REQUEST['programId']."'
             WHERE r.deleted=0";
