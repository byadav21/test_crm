...
class sendVisitReport
{
    ...
    public function main()
    {
        ...
        $file     = "VendorWiseLeadAllocation_3PM_report";
        $where    = '';
        ...
        $emailData = $mail->emailData3pm('Vendor Wise Lead Allocation 3PM Report', $filename, $this->toDate,$email_summary);
	...
	public function getReEnquired(){
		...
		$leadSql = "SELECT COUNT(leads.id) AS lead_count,
             ...
             WHERE leads.status_description IN ('Re-Enquired') AND leads.date_entered >= '$this->fromDate 00:00:00' AND leads.date_entered <= '$this->toDate 15:00:00'
	...
	public function getDuplicate(){
		...
		$leadSql = "SELECT COUNT(leads.id) AS lead_count,
             ...
             LEFT JOIN te_ba_batch ON leads_cstm.te_ba_batch_id_c = te_ba_batch.id
             LEFT JOIN te_vendor on lower(leads.vendor)=lower(te_vendor.name)
             WHERE leads.status_description IN ('Duplicate') AND leads.date_entered >= '$this->fromDate 00:00:00' AND leads.date_entered <= '$this->toDate 15:00:00'
	...
	public function getFresh(){
		...
		$leadSql = "SELECT COUNT(leads.id) AS lead_count,
             ...
             AND leads.date_entered >= '$this->fromDate 00:00:00' AND leads.date_entered <= '$this->toDate 15:00:00'
	...
	public function getAll(){
		...
		$leadSql = "SELECT COUNT(leads.id) AS lead_count,
             ...
             LEFT JOIN te_ba_batch ON leads_cstm.te_ba_batch_id_c = te_ba_batch.id
             LEFT JOIN te_vendor on lower(leads.vendor)=lower(te_vendor.name)
             WHERE leads.date_entered >= '$this->fromDate 00:00:00' AND leads.date_entered <= '$this->toDate 15:00:00' 
	...
	public function getSummary(){
		...
		$leadSql = "SELECT COUNT(leads.id) AS lead_count,
                            ...
                            WHERE leads.date_entered >= '$this->fromDate 00:00:00'
                              AND leads.date_entered <= '$this->toDate 15:00:00'
...
$mainObj->toDate   = date('Y-m-d');
$mainObj->fromDate = date('Y-m-d');
