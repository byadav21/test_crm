...
class sendVisitReport
{
    ...
    public function main()
    {
        ...
        $file     = "ecornellvendorwise_report";
        $where    = '';
        ...
        $emailData = $mail->emailData('eCornell Vendor Wise Lead Allocation Report', $filename, $this->toDate,$email_summary);
	...
	public function getReEnquired(){
		...
		$leadSql = "SELECT COUNT(leads.id) AS lead_count,
             ...
             LEFT JOIN te_in_institutes_te_ba_batch_1_c AS ib ON leads_cstm.te_ba_batch_id_c=ib.te_in_institutes_te_ba_batch_1te_ba_batch_idb AND ib.deleted=0
             LEFT JOIN te_in_institutes as i on ib.te_in_institutes_te_ba_batch_1te_in_institutes_ida=i.id AND i.deleted=0

             WHERE  i.name='Cornell' and leads.status_description IN ('Re-Enquired') AND leads.date_entered >= '$this->fromDate 00:00:00' AND leads.date_entered <= '$this->toDate 23:59:59'
	...
	public function getDuplicate(){
		...
		$leadSql = "SELECT COUNT(leads.id) AS lead_count,
             ...
             LEFT JOIN te_in_institutes_te_ba_batch_1_c AS ib ON leads_cstm.te_ba_batch_id_c=ib.te_in_institutes_te_ba_batch_1te_ba_batch_idb AND ib.deleted=0
             LEFT JOIN te_in_institutes as i on ib.te_in_institutes_te_ba_batch_1te_in_institutes_ida=i.id AND i.deleted=0
             WHERE i.name='Cornell' and  leads.status_description IN ('Duplicate') AND leads.date_entered >= '$this->fromDate 00:00:00' AND leads.date_entered <= '$this->toDate 23:59:59'
	...
	public function getAll(){
		...
		$leadSql = "SELECT COUNT(leads.id) AS lead_count,
             ...
             LEFT JOIN te_in_institutes_te_ba_batch_1_c AS ib ON leads_cstm.te_ba_batch_id_c=ib.te_in_institutes_te_ba_batch_1te_ba_batch_idb AND ib.deleted=0
             LEFT JOIN te_in_institutes as i on ib.te_in_institutes_te_ba_batch_1te_in_institutes_ida=i.id AND i.deleted=0
             WHERE i.name='Cornell' and leads.date_entered >= '$this->fromDate 00:00:00' AND leads.date_entered <= '$this->toDate 23:59:59' 
