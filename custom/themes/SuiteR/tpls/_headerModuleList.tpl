                                        ...
                                        <li>
                                            ...
                                            {if $modulekey == $MODULE_TAB}
                                                {if count($shortcutTopMenu.$modulekey) > 0}
                                                    <ul id="showactive" class="nav child_menu" style="display:block!important">
                                                        {foreach from=$shortcutTopMenu.$modulekey item=item}
                                                            {if $item.URL == "-"}
                                                                <li><a></a><span>&nbsp;</span></li>
                                                                    {else}
                                                                        {if $item.LABEL ne "Create Report" && $item.LABEL ne "View Reports" && $item.LABEL ne "Import"} 
                                                    ...
                                                    <script> $('#showactive').parent().css('display', 'block');
                                                        $('#showactive').parent().parent().css('display', 'block');
                                                        $('#showactive').parent().parent().parent().addClass('active');</script>
